...
本研究は、昨年度の卒業研究[「環境音の特徴を捉える潜在空間表現の設計」](https://github.com/nomukoh/traffic-acoustic-analysis)の研究を引き継いでいます。

本コードは、論文に記載した実験結果の再現性を担保する目的で公開されていますが、研究プロトタイプとしての提供であり、今後のメンテナンスやサポートは行いません。  

> 2026年度の専攻科研究 I では、昨年度に確認された simulation-to-real
> ドメインギャップを主課題として扱います。研究目的、事前登録した評価手順、
> 文献調査、進捗日誌、中間報告書は [`docs/research_2026/`](./docs/research_2026/plan.md)
> にまとめています。
